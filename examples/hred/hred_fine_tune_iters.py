...
def load_trainer_factory(options, emb_dim, vocab_size, embeddings, pad_index,
                    sos_index, loadfrom, checkpoint_dir=None, device=DEVICE):
...
if __name__ == '__main__':
    ...
    trainer = load_trainer_factory(options, emb_dim, vocab_size, embeddings,
