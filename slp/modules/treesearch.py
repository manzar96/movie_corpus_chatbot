...
def _treesearch_factory(genoptions, START_IDX, END_IDX, NULL_IDX, device='cpu'):

    if genoptions.method == 'greedy':
        return GreedySearch(
            genoptions.beam_size,
            min_length=genoptions.beam_min_length,
            block_ngram=genoptions.beam_block_ngram,
            context_block_ngram=genoptions.beam_context_block_ngram,
            length_penalty=genoptions.beam_length_penalty,
            padding_token=NULL_IDX,
            bos_token=START_IDX,
            eos_token=END_IDX,
            device=device,
        )
    elif genoptions.method == 'beam':
        return BeamSearch(
            genoptions.beam_size,
            min_length=genoptions.beam_min_length,
            block_ngram=genoptions.beam_block_ngram,
    ...
    elif genoptions.method == 'delayedbeam':
        return DelayedBeamSearch(
            genoptions.topk,
            genoptions.beam_delay,
            genoptions.beam_size,
            min_length=genoptions.beam_min_length,
            block_ngram=genoptions.beam_block_ngram,
            context_block_ngram=genoptions.beam_context_block_ngram,
    ...
    elif genoptions.method == 'nucleus':
        ...
        raise ValueError(f"Can't use inference method {genoptions.method}")
